...
public class ContentApprovePOActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_content_po);

        getSupportFragmentManager().beginTransaction().replace(R.id.frameApprove, new ApprovePOFragment())
                .addToBackStack(null)
                .commit();
        ...
        */
        ...
        fabLogoutA.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AlertDialog.Builder ab = new AlertDialog.Builder(ContentApprovePOActivity.this);
                ...
                ab.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        // body
                        SharedPreferences spl = (ContentApprovePOActivity.this)
                                    ...
                                    if(st == false)
                                    {
                                        ...
                                        runOnUiThread(new Runnable() {
                                            ...
                                            public void run() {
                                                ...
                                                Intent i = new Intent(ContentApprovePOActivity.this, LoginActivity.class);
    ...
    //Intent i = new Intent(ContentApprovePOActivity.this, HomeUserActivity.class);
    // startActivity(i);
    //}
