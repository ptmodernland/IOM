...
public class ContentKategoriActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        */
        ...
        fabLogoutA.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AlertDialog.Builder ab = new AlertDialog.Builder(ContentKategoriActivity.this);
                ...
                ab.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        // body
                        SharedPreferences spl = (ContentKategoriActivity.this)
                                    ...
                                    if(st == false)
                                    {
                                        ...
                                        runOnUiThread(new Runnable() {
                                            ...
                                            public void run() {
                                                ...
                                                Intent i = new Intent(ContentKategoriActivity.this, LoginActivity.class);
