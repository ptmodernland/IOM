 ...
 */
public class ListPOFragment extends Fragment {

    public ListPOFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View x = inflater.inflate(R.layout.fragment_list_po, container, false);
        ...
        Request request = new Request.Builder()
                .get()
                .url(Setting.IP + "list_po.php?username=" + username)
                .build();
        ...
        postman.newCall(request).enqueue(new Callback() {
            ...
            public void onResponse(Call call, Response response) throws IOException {
                ...
                try {
                    ...
                    final ListPOAdapter adapter = new ListPOAdapter();
