...
public class ContentListPOActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_content_list_po);

        getSupportFragmentManager().beginTransaction().replace(R.id.frameMemo, new ListPOFragment())
                .addToBackStack(null)
                .commit();
        ...
        */
        ...
        fabLogout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AlertDialog.Builder ab = new AlertDialog.Builder(ContentListPOActivity.this);
                ...
                ab.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        // body
                        SharedPreferences spl = (ContentListPOActivity.this)
                                    ...
                                    if(st == false)
                                    {
                                        ...
                                        runOnUiThread(new Runnable() {
                                            ...
                                            public void run() {
                                                ...
                                                Intent i = new Intent(ContentListPOActivity.this, LoginActivity.class);
