...
public class HomePOActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_home_po);
        ...
        navmain.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                if (menuItem.getItemId() == R.id.menuChange) {
                    ...
                    AlertDialog.Builder mBuilder = new AlertDialog.Builder(HomePOActivity.this);
                    ...
                    mSubmit.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            // body
                            SharedPreferences sp = (HomePOActivity.this)
                    ...
                    AlertDialog.Builder ab = new AlertDialog.Builder(HomePOActivity.this);
                    ...
                    ab.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            // body
                            SharedPreferences spl = (HomePOActivity.this)
                                    .getSharedPreferences("DATALOGIN", 0);
                                        ...
                                        if(st == false)
                                        {
                                            ...
                                            runOnUiThread(new Runnable() {
                                                ...
                                                public void run() {
                                                    ...
                                                    Intent i = new Intent(HomePOActivity.this, LoginActivity.class);
        ...
        final ProgressDialog pd = new ProgressDialog(HomePOActivity.this);
        pd.setMessage("Please wait");
        pd.setTitle("Loading ...");
        pd.setIcon(R.drawable.ic_check_black_24dp);
    ...
    public void ApprovePO(View view) {
            Intent i = new Intent(HomePOActivity.this, ContentApprovePOActivity.class);
            startActivity(i);
